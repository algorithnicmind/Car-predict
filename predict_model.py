...
if null_count > 0:
    print(f"⚠️  Found {null_count} null values — dropping affected rows …")
    df = df.dropna()
...
print(f"\n✅ After encoding: {X.shape[1]} feature columns")
...
def evaluate(name, y_true, y_pred):
    ...
    return {'Model': name, 'R² Score': r2, 'MAE (₹)': mae, 'RMSE (₹)': rmse}
...
print(f"\n🏆 Winner: {winner}  (+{improvement:.2f}% R² improvement)")
...
print("\n" + "=" * 70)
print("   ✅ Done! Both models trained and compared successfully.")
print("=" * 70)
